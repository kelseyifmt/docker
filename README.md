...
COMANDO | DESCRIÇÃO
--- | ---
`docker inspect -f '{{.Name}} - {{range .NetworkSettings.Networks}}{{.IPAddress}}{{end}}' $(docker ps -aq)` | Lista todos os Ips dos container.
...
### Ferramenta basica de Redes
`docker run --name netshoot --rm -it nicolaka/netshoot /bin/bash`
 - Fonte: [netshoot](https://github.com/nicolaka/netshoot)
